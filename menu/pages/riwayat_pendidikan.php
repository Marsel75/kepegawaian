        ...
        <div class="modal-content">
            <form name="FormRiwayatPendidikan" action="" method="POST" id="form_advanced_validation">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group form-float">
                        <div class="form-line">
                            <input type="text" class="form-control" name="Tgl_Ijazah" required/>
...
if(isset($_POST['add']))
{
    ...
    $q = mysql_query("insert into riwayat_pendidikan values('', '$No','$Jenjang_Pendidikan','$Jurusan','$No_Ijazah','$Tgl_Ijazah','$Tempat','$Ketua')")or die(mysql_error());
    if($q)
    {
