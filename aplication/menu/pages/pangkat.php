                                        ...
                                        <div class="modal-content">
                                            <form name="FormPangkat" action="" method="POST" id="form_advanced_validation">
                                                <div class="modal-header">
                                                    <h4 class="modal-title" id="defaultModalLabel">Update Pangkat</h4>
                                                </div>
                                                <div class="modal-body">

                                                    <div class="form-group form-float">
                                                        <div class="form-line">
                                                            <input type="hidden" class="form-control" name="Id" value="<?php echo $dtjabatan['Id']?>"/>
                                                            <input type="text" class="form-control" name="pangkat" value="<?php echo $dtjabatan['Pangkat']?>" required/>
                                                            <label class="form-label">Pangkat</label>
                                                        </div>
                                                    </div>
                                                    <div class="form-group form-float">
                                                        <div class="form-line">
                                                            <input type="text" class="form-control" name="golongan" value="<?php echo $dtjabatan['Golongan']?>" required/>
...
<div class="modal fade" id="defaultModal" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form name="FormPangkat" action="" method="POST" id="form_advanced_validation">
                <div class="modal-header">
                    <h4 class="modal-title" id="defaultModalLabel">Tambah Pangkat</h4>
                </div>
                <div class="modal-body">
...
if(isset($_POST['Update']))
{
    ...
    $q = mysql_query("update pangkat set Pangkat='$pangkat', Golongan = '$golongan' WHERE Id='$Id'")or die(mysql_error());
    if($q)
    {
